  ...
  return (
    <div className="weather-card">
      ...
      <div className="weather-meta">
        <span>
          <i className="fa-solid fa-droplet"></i> Rain Probability: 37%
        </span>
        <span>
          <i className="fa-solid fa-water"></i> Humidity: 78%
        </span>
        <span>
          <i className="fa-solid fa-wind"></i> Wind Speed: 12 km/h
        </span>
      </div>
      
      <div className="forecast-row">
        <div className="forecast-day">
          <div className="d">Tue</div>
          <div className="icon">
            <i className="fa-solid fa-cloud-sun"></i>
          </div>
          29°/24°
